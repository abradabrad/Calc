...
public class DataRead { //Чтение данных с проверкой на правильность
    ...
    public String[] read() {
        int i = 0;
        System.out.println("Введите выражение, состоящее из двух целых чисел от "+ System.lineSeparator()+"1 до 10 и знака операции через пробел (напр. 2 + 2): ");
        ...
        for (
            String in_string : input.split(" ", 3)) { //Делим на символы, загоняем в массив
        ...
        for (int i1 = 0; i1 < rome.length; i1++) {
              if (rome[i1].equals(blocks[0]) || rome[i1].equals(blocks[2])) {
                blocks[3] = "1";//Римские, если флаг 1
              }
